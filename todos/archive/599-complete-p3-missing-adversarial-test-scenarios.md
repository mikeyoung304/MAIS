...
resolution: 'Added 33 new tests across 4 categories (indirect injection, encoding bypass, context exhaustion, multi-turn escalation) to adversarial-edge-cases.test.ts'
---
