...
- [ ] Cache is invalidated after successful write tool execution
- [ ] Subsequent messages reflect fresh data
- [ ] Write tools are properly identified
- [ ] No performance regression from invalidation
