...
- No visual indication that packages *belong to* segments
...
1. **Cognitive Confusion:** Tenants see "Packages" and "Segments" as separate tabs, implying they're different kinds of things. In reality, segments are *categories* that contain packages.
