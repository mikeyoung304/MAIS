...
import type { CustomerDetailsStepProps, CustomerDetails } from './types';

const CustomerDetailsStep = React.memo(
  ({ customerDetails, onUpdateField, validationErrors }: CustomerDetailsStepProps) => {
    return (
...
CustomerDetailsStep.displayName = 'CustomerDetailsStep';
