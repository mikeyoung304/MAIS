...
const PackageCatalog = lazy(() =>
  import('./pages/PackageCatalog').then((m) => ({ default: m.PackageCatalog }))
);
const SegmentLanding = lazy(() =>
  import('./pages/SegmentLanding').then((m) => ({ default: m.SegmentLanding }))
);
...
const TenantAdminDashboard = lazy(() =>
  import('./pages/tenant/TenantAdminDashboard').then((m) => ({ default: m.TenantAdminDashboard }))
);
...
const StorefrontHome = lazy(() =>
  import('./pages/StorefrontHome').then((m) => ({ default: m.StorefrontHome }))
);
const SegmentTiers = lazy(() =>
  import('./pages/SegmentTiers').then((m) => ({ default: m.SegmentTiers }))
);
const RootTiers = lazy(() => import('./pages/RootTiers').then((m) => ({ default: m.RootTiers })));
const SegmentTierDetail = lazy(() =>
  import('./pages/TierDetailPage').then((m) => ({ default: m.SegmentTierDetail }))
);
const RootTierDetail = lazy(() =>
  import('./pages/TierDetailPage').then((m) => ({ default: m.RootTierDetail }))
);
...
const TenantSchedulingAvailabilityPage = lazy(() =>
  import('./pages/tenant/TenantSchedulingAvailability').then((m) => ({
    default: m.TenantSchedulingAvailabilityPage,
  }))
);
const TenantSchedulingAppointmentsPage = lazy(() =>
  import('./pages/tenant/TenantSchedulingAppointments').then((m) => ({
    default: m.TenantSchedulingAppointmentsPage,
  }))
);

// Visual editor page
const TenantVisualEditorPage = lazy(() =>
