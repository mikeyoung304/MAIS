...
/**
 * DashboardView - Core dashboard content component
 *
 * Extracted from the dashboard page to allow reuse in ContentArea.
 * This component shows:
 * - Trial status banner
 * - Welcome header
 * - Stat cards (packages, bookings, blackouts, payments)
 * - Quick action buttons
 * - Getting started prompt
 *
 * @see app/(protected)/tenant/dashboard/page.tsx for usage
 * @see components/dashboard/ContentArea.tsx for integration
 */
 ...
 *
 * Shows the main dashboard content with stats, actions, and trial status.
 * Can be rendered directly or through ContentArea when agent is in dashboard mode.
 */
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {quickActions.map((action) => {
            // Determine if this is a link or button action
            const isButton = 'onClick' in action && action.onClick;
