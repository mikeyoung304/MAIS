...
import { Star, Users, GraduationCap, type LucideIcon } from 'lucide-react';

/**
 * StorefrontPreview - Alex Chen tutoring storefront mockup for hero
 *
 * Extracted from HeroWithVerticals and hardcoded to show Alex Chen.
 * Specific feels real - tutoring is relatable across demographics.
 *
 * FIX: Removed filler word "actually" from subheadline per copy review.
 */
...
export function StorefrontPreview() {
  const { name, business, initials, headline, subheadline, tiers, trust } = ALEX_CHEN;
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-[10px]">{business}</p>
              </div>
            </div>

            {/* Headline */}
            <h2 className="font-serif font-bold text-white leading-tight text-xl">{headline}</h2>

            {/* Subheadline */}
            <p className="mt-1.5 text-slate-300 leading-snug text-xs">{subheadline}</p>
