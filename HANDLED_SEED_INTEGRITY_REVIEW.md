...
```typescript
const reserved = [
  'api', 'admin', 'app', 'www', 'widget', 'cdn', 'static',
  'assets', 'public', 'private', 'internal', 'system',
  'test', 'staging', 'production', 'dev', 'demo'
];
```
...
| 2. API key format | — | ✅ PASS | Valid pk_live_, sk_live_ formats |
