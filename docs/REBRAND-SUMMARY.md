...
**Old Name:** Macon AI Solutions (MAIS)
**New Name:** HANDLED
...
- Leading with "AI" puts us in a crowded, often-mocked category
...
4. "From overwhelmed to overbooked."
...
- "Handled" as a word is common enough to coexist
...
2. **Sterling & Associates** — Brand identity specialists
3. **Main Street Marketing** — Small business focus
4. **Maison Blanc** — Luxury/premium positioning
5. **Campfire Collective** — Storytelling/narrative
6. **Wordsmith & Co.** — Naming linguistics specialists
7. **The Provocateurs** — Bold/creative agency
...
- "AI" should be a feature, not the headline
...
- [ ] Create landing page on new domain
- [ ] Update Prisma seeds with new tenant name
- [ ] Migrate any MAIS-specific copy
...
- Anything that sounds like 2015 startup speak

---

## Next Session Priorities

1. **Domain acquisition** — Buy the domain
2. **Brand identity brief** — For designer
3. **Codebase updates** — MAIS → Handled
4. **Landing page copy** — First impression matters
